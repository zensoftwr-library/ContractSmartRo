...
function NewsCard({ stire }) {
  ...
  return (
    <a href={stire.link} target="_blank" rel="noreferrer" className="group flex flex-col bg-[#0B0F12] border border-slate-800/80 rounded-2xl overflow-hidden hover:border-[#8ba888]/50 hover:-translate-y-1 hover:shadow-[0_10px_30px_-15px_rgba(139,168,136,0.3)] transition-all duration-300 h-full relative">
      ...
      {/* Container Imagine - Protejat prin style inline să rămână dark și în tema de zi */}
      <div className="w-full h-44 overflow-hidden relative border-b border-slate-800/60" style={{ backgroundColor: '#12181D' }}>
        {showImage ? (
          <>
          ...
          <div className="flex flex-col items-center justify-center h-full p-4 text-center relative z-0 opacity-50 group-hover:opacity-80 transition-opacity">
