...
import Footer from '../components/Footer'; // Importat Footer-ul global
...
export default function ModeleContracte() {
  ...
  const handleCumparaPremium = (tipProdus = 'founder') => {
    if (!user) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0B0F12] text-slate-200 font-sans selection:bg-[#8ba888]/30 selection:text-[#8ba888]">
