...
export async function POST(request) {
  try {
    ...
    // --- LOGICA FREEMIUM / CREDITE (VERIFICARE PAYWALL) ---
    if (!userId) {
    ...
    const isPremium = ['pro', 'founder', 'premium'].includes(profile?.subscription_tier);
    ...
    // GENERARE AUTOMATĂ A TEMEIULUI JURIDIC CONFORM CODULUI CIVIL / LEGILOR ÎN VIGOARE ÎN 2026
    ...
    // PROCESAREA CLAUZELOR "ANTI-ȚEAPĂ" INJECTATE DIN DINAMICA DE CONFIGURATOR
    ...
    console.error("Crash generare PDF:", error);
