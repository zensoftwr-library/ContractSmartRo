  ...
  try {
    ...
    return NextResponse.json({
      ...
      date: {
        ...
        // Detaliile critice de km și daune ascunse se injectează exclusiv post-plată
        detalii_premium: areDrepturi ? {
          ...
          statusDaune: "⚠️ ALERTĂ: 1 daună structurală identificată pe puntea spate (Cost reparație estimat: 4.200 EUR).",
